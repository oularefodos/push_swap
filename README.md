...
# ALGORITHME
* Je prends toutes mes données pour leurs mettre dans un stack a avec la methode fifo.
* Puis, j'ai créé un tableau de référence où je met toutes mes données puis leurs triées avec le tri par insertion.
